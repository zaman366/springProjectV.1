                ...
                <div class="container my-4">
                    ...
                    <div class="row">
                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#assain" role="tab" aria-controls="home" aria-selected="false">Assign Task</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#status" role="tab" aria-controls="profile" aria-selected="false">View Status</a>
                                    </li>
                      ...
                      <!-- Assign Task-->
                                    ...
                                    <div class="tab-pane fade" id="assain" role="tabpanel" aria-labelledby="home-tab">

                                        <section>
                                            <div class="container-fluid">
                                                <div class="container mt-5">
                                                    <div ><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Assign Task</h4></div>
                                                    <form >
                        ...
                        <!--   view Status-->
                                    <div class="tab-pane fade" id="status" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <div class="container-fluid">
                                            <h3 class="text-dark mb-4">View Status</h3>
