    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
          ...
          <fieldset class="border p-2">
            <legend> <h4>Leave Request Details</h4></legend>
         

         
            <label>Request Number Of Days: <h2>5</h2></label>
        <br/>

         <div class="form-group">
        <label for="comment">Leave Reason In Detail:</label>
        <textarea class="form-control" rows="5" id="comment"> For Sickness</textarea>
       </div> 
        <br/>
        <input type="text" class="form-control" placeholder="Insert here value of approve days" name="basic_pay">
        <br/>
        <label for="comment">Action:</label>
        <div class="form-group">
            <select class="form-control" name="empdep">

                          <option value="IT">Approve Application</option>
                         <option value=" Accounts">Reject Application</option>
