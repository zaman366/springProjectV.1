...
<div class="register-photo1">
        <div class="form-container">
            <div class="image-holder"></div>
            <form action="/employeeDash" method="post">
                <h2 class="text-center"><strong>Employee Login</strong></h2>
                     <div class="form-group"><input class="form-control" type="password" name="companycode" placeholder="Company Code"></div>
                <div class="form-group"><input class="form-control" type="email" name="employeeEmail" placeholder="Employee Email"></div>
                <div class="form-group"><input class="form-control" type="password" name="employeeId" placeholder="Employee ID"></div>
           
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Login</button></div>
<!--                <a class="already" href="#">Click&nbsp; here to create an account</a>-->
            </form>
        </div>
    </div>
