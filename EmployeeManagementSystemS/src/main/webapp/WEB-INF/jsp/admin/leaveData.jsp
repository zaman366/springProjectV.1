                            ...
                            <section>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#leave" role="tab" aria-controls="home" aria-selected="false">Leave Request Table</a>
                                    </li>
<!--                                    <li class="nav-item waves-effect waves-light">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade" id="leave" role="tabpanel" aria-labelledby="home-tab">

                                        <section>
                                            <div class="container-fluid">
                                                <div class="container mt-5">

                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">List Of Applicant</h4></div>
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="card shadow">
                                                <div class="card-header py-3">
                                                    <p class="text-primary m-0 font-weight-bold">Semister Info</p>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
